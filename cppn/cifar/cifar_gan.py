...
class Generator(nn.Module):
    ...
    def forward(self, args, inputs):
        ...
        #x = F.leaky_relu(self.linear_h5(x))
        #x = F.leaky_relu(self.linear_h6(x))
        #x = F.leaky_relu(self.linear_h7(x))
...
def train(args):
    ...
    exp_dir = 'cifar_dog_fixed_z'+str(args.z)+'n'+str(args.net)+'s'+str(args.scale) 
