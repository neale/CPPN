...
def load_args():
    ...
    parser.add_argument('--net', default=64, type=int, help='net width')
...
def train(args):
    ...
    exp_dir = 'cifar_ae_fixed2_z'+str(args.z)+'n'+str(args.net)+'s'+str(args.scale) 
    ...
    for iter in range(args.epochs):
        ...
        if iter % 200 == 0:
            with torch.no_grad():
                ae_samples = sample(args, netG, netE(data)).mul(.5).add(.5)
